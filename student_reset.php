...
// Redirect if session not set for employer
...
<head>
    ...
    <style>
        ...
        input[type=password] {
            width: 90%; padding: 10px 15px; margin-bottom: 15px;
            border-radius: 25px; border: 1px solid #ccc; outline: none; font-size: 14px;
        }
        button {
            width: 95%; padding: 12px 20px; border: none;
            border-radius: 25px; background: #5563DE; color: #fff;
            font-size: 14px; font-weight: bold; cursor: pointer; transition: 0.3s;
        }
        button:hover { background: #3f4cb7; }
